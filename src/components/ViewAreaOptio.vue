...
import AreaOptionsVue from "@/common/AreaOptionsVue.vue";
...
<template>
  <div>
    ...
    <template v-else-if="valoresArray && valoresArray.length > 0">
      <AreaOptionsVue  :series="valoresArray" :name="Datos"
                     :fecha="valorFecha" :y="props.y" :y2="props.y2"></AreaOptionsVue>
      <button type="button"
