...
login.postLoginStore(data)
const validacion = login.validacion;
    if (validacion) {
        console.log('Coorrectp');
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" v-on:submit.prevent="loguearse()">
                        <div>
                            <label for="username"
                        ...
                        <!-- Recordar la contrase;a y recuperar la contrase;a
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Crear una cuenta
                            <a href="#"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500">Continuar</a>
                        </p>
                    </form>
                </div>
            </div>
